...
class ApplicantApplicationModel extends TenantScopedModel
{
    ...
    protected $allowedFields = ['tenant_id', 'applicant_profile_id', 'admission_cycle_id', 'programme_opening_id', 'public_token', 'application_number', 'status', 'lock_version', 'biodata_status', 'started_at', 'last_saved_at', 'submitted_at', 'submission_snapshot_id', 'submission_version', 'created_by', 'updated_by'];
