...
class AdmissionNotificationOutboxModel extends TenantScopedModel
{
    ...
    protected $allowedFields = ['tenant_id', 'event_name', 'channel', 'recipient', 'payload_json', 'idempotency_key', 'status', 'available_at', 'attempts', 'locked_at', 'locked_by', 'last_error', 'failed_at', 'sent_at', 'created_by', 'updated_by'];
